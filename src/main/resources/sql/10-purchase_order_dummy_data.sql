...
--   - vendor_product 27건 (id 1~27) — product_master 의 fashion 상품 매핑
...
-- ──────────────────────────────────────────────
-- 2) VENDOR_PRODUCT (27건, id 1~27 — 알파벳 정렬)
-- ──────────────────────────────────────────────
...
VALUES
('VP-OUT-CD-001-V05', 5, 'PRD-OUT-CD-001', '브이넥 버튼 가디건',         189100, 50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-CD-002-V06', 6, 'PRD-OUT-CD-002', '케이블 포인트 가디건',       190300, 50,  7, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-CD-003-V07', 7, 'PRD-OUT-CD-003', '오픈프론트 롱 가디건',       191500, 50,  8, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-HZ-001-V01', 1, 'PRD-OUT-HZ-001', '소프트 스웻 후드집업',       165100, 50, 11, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-HZ-002-V02', 2, 'PRD-OUT-HZ-002', '테리 루즈핏 후드집업',       166300, 50,  5, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-HZ-003-V03', 3, 'PRD-OUT-HZ-003', '트랙라인 코튼 집업',         167500, 50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-JK-001-V03', 3, 'PRD-OUT-JK-001', '클래식 싱글 자켓',           177100, 50,  5, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-JK-002-V04', 4, 'PRD-OUT-JK-002', '미니멀 크롭 블레이저',       178300, 50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-JK-003-V05', 5, 'PRD-OUT-JK-003', '유틸리티 필드 자켓',         179500, 50,  7, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-PD-001-V07', 7, 'PRD-OUT-PD-001', '라이트 웜 숏 패딩',          153100, 50, 10, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-PD-002-V08', 8, 'PRD-OUT-PD-002', '볼륨넥 덕다운 패딩',         154300, 50, 11, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-OUT-PD-003-V01', 1, 'PRD-OUT-PD-003', '에센셜 퀼팅 패딩',           155500, 50,  5, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-DN-001-V03', 3, 'PRD-PNT-DN-001', '스트레이트 인디고 데님',     81100,  50, 11, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-DN-002-V04', 4, 'PRD-PNT-DN-002', '슬림 테이퍼드 데님',         82300,  50,  5, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-DN-003-V05', 5, 'PRD-PNT-DN-003', '와이드 워시드 데님',         83500,  50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-LG-001-V07', 7, 'PRD-PNT-LG-001', '와이드 플리츠 롱팬츠',       105100, 50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-LG-002-V08', 8, 'PRD-PNT-LG-002', '테일러드 스트레이트 팬츠',   106300, 50,  7, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-PNT-ST-001-V05', 5, 'PRD-PNT-ST-001', '코튼 치노 쇼츠',             93100,  50,  5, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-SKT-LG-001-V05', 5, 'PRD-SKT-LG-001', '플리츠 플로우 롱스커트',     141100, 50,  9, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-SKT-MN-001-V03', 3, 'PRD-SKT-MN-001', 'A라인 코튼 미니 스커트',     129100, 50,  8, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-KN-001-V07', 7, 'PRD-TOP-KN-001', '파인게이지 라운드 니트',     57100,  50,  9, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-LS-001-V03', 3, 'PRD-TOP-LS-001', '슬림 베이스 레이어 긴팔',    33100,  50,  7, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-LS-002-V04', 4, 'PRD-TOP-LS-002', '소프트 코튼 롱슬리브',       34300,  50,  8, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-SH-001-V05', 5, 'PRD-TOP-SH-001', '옥스포드 버튼다운 셔츠',     45100,  50,  8, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-SS-001-V01', 1, 'PRD-TOP-SS-001', '코튼 에센셜 크루 반팔',      21100,  50,  6, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-SS-002-V02', 2, 'PRD-TOP-SS-002', '드라이핏 액티브 반팔',       22300,  50,  7, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW()),
('VP-TOP-SS-003-V03', 3, 'PRD-TOP-SS-003', '실켓 터치 라운드 반팔',      23500,  50,  8, '2025-01-01', '2026-12-31', 'ACTIVE', NOW(), NOW())
ON DUPLICATE KEY UPDATE
...
(1109, 'PO-202512-0005', 8, '코스메틱플러스',   '한코스', 3, '경기 남부 통합 배송센터',     'hq0001', '본사관리자', 'COMPLETED', 2019000, NULL, '2025-12-28 13:00:00', NOW()),
-- 2026-01
(1110, 'PO-202601-0001', 6, '패션라인(주)',     '김패션', 1, '서울 도심 풀필먼트 허브',     'hq0001', '본사관리자', 'COMPLETED', 3863500, NULL, '2026-01-05 09:30:00', NOW()),
...
(1113, 'PO-202601-0004', 3, '글로벌오피스',     '정사무', 5, '인천 송도 국제물류센터',     'hq0001', '본사관리자', 'COMPLETED', 3437400, NULL, '2026-01-23 16:15:00', NOW()),
(1114, 'PO-202601-0005', 6, '패션라인(주)',     '김패션', 3, '경기 남부 통합 배송센터',     'hq0001', '본사관리자', 'CANCELLED', 1679000, NULL, '2026-01-29 10:00:00', NOW()),
-- 2026-02
(1115, 'PO-202602-0001', 6, '패션라인(주)',     '김패션', 1, '서울 도심 풀필먼트 허브',     'hq0001', '본사관리자', 'COMPLETED', 5367000, NULL, '2026-02-04 13:20:00', NOW()),
(1116, 'PO-202602-0002', 5, '스마트주방솔루션', '오주방', 2, '서울 동북권 스마트 물류센터', 'hq0001', '본사관리자', 'COMPLETED', 2643200, NULL, '2026-02-10 11:40:00', NOW()),
(1117, 'PO-202602-0003', 6, '패션라인(주)',     '김패션', 4, '경기 북부 이커머스 물류센터', 'hq0001', '본사관리자', 'COMPLETED', 4163500, NULL, '2026-02-16 15:00:00', NOW()),
...
(1122, 'PO-202603-0003', 1, '(주)테크서플라이', '이공급', 2, '서울 동북권 스마트 물류센터', 'hq0001', '본사관리자', 'COMPLETED', 2962000, NULL, '2026-03-15 11:15:00', NOW()),
(1123, 'PO-202603-0004', 6, '패션라인(주)',     '김패션', 4, '경기 북부 이커머스 물류센터', 'hq0001', '본사관리자', 'COMPLETED', 4822000, NULL, '2026-03-20 13:45:00', NOW()),
(1124, 'PO-202603-0005', 7, '슈즈모아',         '박슈즈', 5, '인천 송도 국제물류센터',     'hq0001', '본사관리자', 'COMPLETED', 2494500, NULL, '2026-03-26 15:10:00', NOW()),
-- 2026-04
(1125, 'PO-202604-0001', 6, '패션라인(주)',     '김패션', 1, '서울 도심 풀필먼트 허브',     'hq0001', '본사관리자', 'COMPLETED', 5330800, NULL, '2026-04-02 10:00:00', NOW()),
(1126, 'PO-202604-0002', 6, '패션라인(주)',     '김패션', 2, '서울 동북권 스마트 물류센터', 'hq0001', '본사관리자', 'COMPLETED', 3736800, NULL, '2026-04-08 14:40:00', NOW()),
(1127, 'PO-202604-0003', 6, '패션라인(주)',     '김패션', 3, '경기 남부 통합 배송센터',     'hq0001', '본사관리자', 'ARRIVED',   4307000, NULL, '2026-04-15 11:30:00', NOW()),
(1128, 'PO-202604-0004', 7, '슈즈모아',         '박슈즈', 4, '경기 북부 이커머스 물류센터', 'hq0001', '본사관리자', 'ARRIVED',   2564000, NULL, '2026-04-20 16:50:00', NOW()),
(1129, 'PO-202604-0005', 6, '패션라인(주)',     '김패션', 1, '서울 도심 풀필먼트 허브',     'hq0001', '본사관리자', 'ARRIVED',   3875500, NULL, '2026-04-25 13:15:00', NOW()),
(1130, 'PO-202604-0006', 6, '패션라인(주)',     '김패션', 5, '인천 송도 국제물류센터',     'hq0001', '본사관리자', 'ARRIVED',   2860000, NULL, '2026-04-28 09:20:00', NOW())
ON DUPLICATE KEY UPDATE
  vendor_id = VALUES(vendor_id),
...
(1109, 27, 'PRD-TOP-SS-003', '실켓 터치 라운드 반팔', 'SKU-PRD-TOP-SS-003-BEI-S', 'BEIGE', 'S', 23500, 50, 1175000),
(1109, 25, 'PRD-TOP-SS-001', '코튼 에센셜 크루 반팔', 'SKU-PRD-TOP-SS-001-GRY-M', 'GREY',  'M', 21100, 40, 844000),
-- 1110 (3,863,500) 패션라인 COMPLETED
(1110, 12, 'PRD-OUT-PD-003', '에센셜 퀼팅 패딩',       'SKU-PRD-OUT-PD-003-BLK-L', 'BLACK', 'L', 155500, 15, 2332500),
...
(1113, 3,  'PRD-OUT-CD-003', '오픈프론트 롱 가디건',   'SKU-PRD-OUT-CD-003-BRN-L', 'BROWN', 'L', 191500, 10, 1915000),
...
(1115, 9,  'PRD-OUT-JK-003', '유틸리티 필드 자켓',     'SKU-PRD-OUT-JK-003-BLK-L', 'BLACK', 'L', 179500, 15, 2692500),
(1115, 8,  'PRD-OUT-JK-002', '미니멀 크롭 블레이저',   'SKU-PRD-OUT-JK-002-NVY-M', 'NAVY',  'M', 178300, 15, 2674500),
-- 1116 (2,643,200) 스마트주방솔루션 COMPLETED
(1116, 15, 'PRD-PNT-DN-003', '와이드 워시드 데님',     'SKU-PRD-PNT-DN-003-BLU-L', 'BLUE',  'L', 83500, 20, 1670000),
(1116, 13, 'PRD-PNT-DN-001', '스트레이트 인디고 데님', 'SKU-PRD-PNT-DN-001-BLU-M', 'BLUE',  'M', 81100, 12, 973200),
-- 1117 (4,163,500) 패션라인 COMPLETED
(1117, 6,  'PRD-OUT-HZ-003', '트랙라인 코튼 집업',     'SKU-PRD-OUT-HZ-003-BLK-L', 'BLACK', 'L', 167500, 15, 2512500),
...
(1122, 27, 'PRD-TOP-SS-003', '실켓 터치 라운드 반팔', 'SKU-PRD-TOP-SS-003-GRY-S', 'GREY',  'S', 23500, 40, 940000),
...
(1124, 27, 'PRD-TOP-SS-003', '실켓 터치 라운드 반팔', 'SKU-PRD-TOP-SS-003-NVY-S', 'NAVY',  'S', 23500, 30, 705000),
-- 1125 (5,330,800) 패션라인 COMPLETED — 3 items
(1125, 3,  'PRD-OUT-CD-003', '오픈프론트 롱 가디건',   'SKU-PRD-OUT-CD-003-BRN-L', 'BROWN', 'L', 191500, 10, 1915000),
...
(1127, 6,  'PRD-OUT-HZ-003', '트랙라인 코튼 집업',     'SKU-PRD-OUT-HZ-003-GRY-L', 'GREY',  'L', 167500, 1,  167500),
...
(1129, 12, 'PRD-OUT-PD-003', '에센셜 퀼팅 패딩',       'SKU-PRD-OUT-PD-003-BLK-L', 'BLACK', 'L', 155500, 15, 2332500),
...
(1130, 9,  'PRD-OUT-JK-003', '유틸리티 필드 자켓',     'SKU-PRD-OUT-JK-003-GRY-M', 'GREY',  'M', 179500, 6,  1077000);
